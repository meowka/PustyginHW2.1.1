                ...
                switch (compoundButton.getId()) {
                    case R.id.bankCardChkBx:
                        ...
                        mBtnOk.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Toast.makeText(MainActivity.this, R.string.toastBankCard, Toast.LENGTH_LONG).show();
                            }
                        });
                        break;
                    case R.id.mobilePhoneChkBx:
                        ...
                        mBtnOk.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(MainActivity.this, R.string.toastMobilePhone, Toast.LENGTH_LONG).show();
                            }
                        });
                        break;
                    case R.id.cashAddressChkBx:
                        ...
                        mBtnOk.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(MainActivity.this, R.string.toastCash, Toast.LENGTH_LONG).show();
                            }
                        });
                        break;
                    default:
